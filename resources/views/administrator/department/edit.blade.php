<form action="/department/{{ $department->kode_dept }}/update" method="POST" id="formDepartment" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$department->kode_dept}}" readonly disabled name="kode_dept" id="kode_dept" class="form-control" placeholder="Kode Departemen">
            </div>
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                    <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                ...
                <input type="text" value="{{$department->nama_dept}}" name="nama_dept" id="nama_dept" class="form-control" placeholder="Nama Departemen">
            </div>
